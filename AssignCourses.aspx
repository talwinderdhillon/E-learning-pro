<%@ Page Title="" Language="C#" MasterPageFile="~/Organization.Master" AutoEventWireup="true" CodeBehind="AssignCourses.aspx.cs" Inherits="e_learning.WebForm7" %>
    ...
    <table class="style1">
        <tr>
            <td>
                &nbsp;</td>
            <td class="style2">
                <strong>Following Courses are approved</strong></td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" Text="Assign Courses" CommandName="Approve" CommandArgument='<%# Eval("id") %>' runat="server" />
                </ItemTemplate>
